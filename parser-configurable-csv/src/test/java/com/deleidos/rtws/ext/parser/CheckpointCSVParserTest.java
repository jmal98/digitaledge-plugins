...
public class CheckpointCSVParserTest {
	...
	public void setUp() throws Exception {
		...
		translator.setInputFormatName("checkpointcsv");
	...
	public void testParse() throws Exception {
		...
		csvParser.setInputStream(new FileInputStream(basedir
				+ "/src/test/resources/Checkpoint_Test.csv"));
	...
	public void testTranslatorHasHeaderNames() throws Exception {
		...
		assertTrue(headers.contains("Plate_Number"));
		assertTrue(headers.contains("Date"));
		assertTrue(headers.contains("Time"));
		assertTrue(headers.contains("Country"));
		assertTrue(headers.contains("City_State"));
		assertTrue(headers.contains("Lat"));
		assertTrue(headers.contains("Lon"));
	}
}
