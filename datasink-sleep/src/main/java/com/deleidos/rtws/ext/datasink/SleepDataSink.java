...
@Description("This data sink continuously reads in a record and then sleeps for a user defined number of milliseconds.")
public class SleepDataSink extends AbstractDataSink {
	
	private long delay;
	private boolean logMessages;
	private Logger log = Logger.getLogger(getClass());
	
	public SleepDataSink() {
		super();
	}
	 ...
	 */
	@Override
	@SystemConfigured(value = "Sleep Data Sink")
	...
	/**
	 * This data sink's short name.
	 */
	@Override
	@SystemConfigured(value = "sleep")
	...
	@UserConfigured(value="5000",
			description="The time to wait between processing records."
	...
	@UserConfigured(value="false",
			description="Log each record to the ingest log.",
			flexValidator = { "RegExpValidator expression=true|false" })
	public void setInputLogging(boolean logging){
		logMessages=logging;
	}
