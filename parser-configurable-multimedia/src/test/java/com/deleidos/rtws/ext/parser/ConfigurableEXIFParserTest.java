...
public class ConfigurableEXIFParserTest {
	...
	public void setUp() throws Exception {
		configurableEXIFParser = new ConfigurableEXIFParser();
		configurableEXIFParser.setDefaultSource("JUNIT1");
		configurableEXIFParser.setDefaultAccessLabel("UNCLASSIFIED");
		basedir = System.getProperty("basedir");
		if (basedir == null) {
			System.err.println("Need to set basedir in system properties at startup time");
		}
		Properties emptyProps = new Properties();
		configurableEXIFParser.setStreamProperties(emptyProps);
		
		translator = new SimpleConfigurableTranslator();
		translator.setModelName("transportation");
		translator.setModelVersion("1.0");
		translator.setInputFormatName("geojpg");
		configurableEXIFParser.setTranslator(translator);
	}
	...
	public void testParse() throws Exception {
		...
		configurableEXIFParser.initialize();
		
		String fileUrl = "file:///" + basedir + "/src/test/resources/exif_sample.JPG";
		//String fileUrl = "http://localhost:8080/contentapi/json/content/object/1292511750\nhttp://localhost:8080/contentapi/json/content/object/1292511751\n";
		
		ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(fileUrl.getBytes());
		configurableEXIFParser.setInputStream(byteArrayInputStream);
		
		while ((jsonObj = configurableEXIFParser.parse()) != null) {
			...
			JSONObject Exif = (JSONObject) jsonObj.getJSONObject("Exif");
	...
	public void testBadFileName() throws Exception {
		...
		String fileUrl = "file:///" + basedir + "/src/test/resources/bogus.JPG";
		
		ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(fileUrl.getBytes());
		configurableEXIFParser.setInputStream(byteArrayInputStream);
		
		configurableEXIFParser.parse();
	} 
}
